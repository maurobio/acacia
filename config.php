...
$config['common'] = true; // common knowledge (common names, uses) data class
$config['ecol'] = true; // ecology (habitats) data class
$config['geog'] = true; // geography (geographic distribution) data class
...
$config['media'] = true; // media resources
$config['point'] = true; // literature pointers
?>