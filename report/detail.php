			...
			if ($num_rows > 0) {
				while($row = mysqli_fetch_array($query)) {
					...
					if ($grpEval != $grpCheck) {
						...
						$result = mysqli_query($link, $sql) or die("Error: MySQL query failed");
