...
<?php
if ($config['readonly']) {
	echo "<h3>Browser - Habitats table</h3>";
} else {
	echo "<h3>Editor - Habitats table</h3>";
}	
?>
</center>
<?php
...
$opts['fdd']['H_PLACE'] = array(
  'name'     => 'Place name',
  'select'   => 'T',
  'maxlen'   => 30,
  'sort'     => true
);
$opts['fdd']['H_HABITAT'] = array(
  'name'     => 'Habitat name',
  'select'   => 'T',
  'maxlen'   => 78,
  'sort'     => true
...
$opts['fdd']['H_PLACE']['js']['required'] = true;
$opts['fdd']['H_PLACE']['js']['hint'] = 'Place name field is required.';
$opts['fdd']['H_PLACE']['values']['table'] = 'geography'; 
$opts['fdd']['H_PLACE']['values']['column'] = 'P_PLACE';
$opts['fdd']['H_HABITAT']['js']['required'] = true;
$opts['fdd']['H_HABITAT']['js']['hint'] = 'Habitat name field is required.';
...
?>
<p>
Download as: <a href="../export/excel.php?table=habitats&sort=T_NO">Excel</a> | <a href="../export/csv.php?table=habitats&sort=T_NO">CSV</a>
</p>
<hr>
<p align="center">
