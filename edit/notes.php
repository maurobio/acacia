...
<?php
if ($config['readonly']) {
	echo "<h3>Browser - Notes table</h3>";
} else {
	echo "<h3>Editor - Notes table</h3>";
}	
?>
</center>
<?php
...
$opts['fdd']['N_NOTE']['js']['required'] = true;
$opts['fdd']['N_NOTE']['js']['hint'] = 'Note field is required.';
...
?>
<p>
Download as: <a href="../export/excel.php?table=notes&sort=T_NO">Excel</a> | <a href="../export/csv.php?table=notes&sort=T_NO">CSV</a>
</p>
<hr>
<p align="center">
