...
<?php
if ($config['readonly']) {
	echo "<h3>Browser - Synonyms table</h3>";
} else {
	echo "<h3>Editor - Synonyms table</h3>";
}	
?>
</center>
<?php
...
$opts['fdd']['S_STATUS'] = array(
  'name'     => 'Synonym status',
  'select'   => 'T',
  'maxlen'   => 22,
  'sort'     => true
);
$opts['fdd']['S_GENUS'] = array(
  'name'     => 'Generic epithet',
  'select'   => 'T',
  'maxlen'   => 30,
  'sort'     => true
);
$opts['fdd']['S_G_AUTHOR'] = array(
...
if ($config['subgen']) {
   $opts['fdd']['S_SUBGENUS'] = array(
     'name'     => 'Subgeneric epithet',
     'select'   => 'T',
     'maxlen'   => 30,
     'sort'     => true
   );
}
$opts['fdd']['S_SPECIES'] = array(
  'name'     => 'Specific epithet',
  'select'   => 'T',
  'maxlen'   => 30,
  'sort'     => true
);
$opts['fdd']['S_S_AUTHOR'] = array(
  'name'     => 'Specific authority',
  'select'   => 'T',
  'maxlen'   => 40,
  'sort'     => true
);
if ($config['subsp']) {
	$opts['fdd']['S_RANK'] = array(
		'name'     => 'Name rank',
		'select'   => 'T',
		'maxlen'   => 7,
		'sort'     => true
	);
	$opts['fdd']['S_SUBSP'] = array(
		'name'     => 'Subspecific epithet',
		'select'   => 'T',
		'maxlen'   => 30,
		'sort'     => true
	);
	$opts['fdd']['S_SP_AUTHOR'] = array(
		'name'     => 'Subspecific authority',
		'select'   => 'T',
		'maxlen'   => 40,
		'sort'     => true
	);
...
//$opts['fdd']['S_STATUS']['values'] = array('', 'Basionym', 'Doubtful', 'Heterotypic', 'Misapplied Name', 'Homotypic', 
//'Orthographic', 'Synonym', 'Unambiguous Synonym', 'Ambiguous Synonym', 'New Comb.', 'New Rank');
$opts['fdd']['S_STATUS']['values2'] = array(
	'Basionym' => 'Basionym', 
	'Doubtful' => 'Doubtful', 
	...
	'Synonym' => 'Synonym', 
	'Unambiguous Synonym' => 'Unambiguous', 
	'Ambiguous Synonym' => 'Ambiguous', 
	'New Comb.' => 'New Combination', 
	'New Rank' => 'New Rank'
);
$opts['fdd']['S_GENUS']['js']['required'] = true;
$opts['fdd']['S_GENUS']['js']['hint'] = 'Generic epithet field is required.';
$opts['fdd']['S_SPECIES']['js']['required'] = true;
$opts['fdd']['S_SPECIES']['js']['hint'] = 'Specific epithet field is required.';
if (!$config['subsp']) {
	$opts['fdd']['S_S_AUTHOR']['js']['hint'] = 'Specific authority field is required.';
}
else {
	$opts['fdd']['S_SP_AUTHOR']['js']['hint'] = 'Subspecific authority field is required.';
}	
...
if ($config['subsp']) {
	//$opts['fdd']['S_RANK']['values'] = array('', 'Species', 'Subspecies', 'Variety');
	$opts['fdd']['S_RANK']['values2'] = array(
		'Species' => 'Species',
		'Subsp.' => 'Subspecies',
		'Var.' => 'Variety'
	);
...
?>
<p>
Download as: <a href="../export/excel.php?table=synonyms&sort=T_NO">Excel</a> | <a href="../export/csv.php?sort=synonyms&field=T_NO">CSV</a>
</p>
<hr>
<p align="center">
