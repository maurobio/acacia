...
<?php
if ($config['readonly']) {
	echo "<h3>Browser - Descriptors table</h3>";
} else {
	echo "<h3>Editor - Descriotors table</h3>";
}	
?>
</center>
<?php
...
// Sorting field(s)
$opts['sort_field'] = array('T_NO', 'D_NO', 'D_CHARACTER', 'D_STATE', 'D_STATE_NO');
...
$opts['fdd']['D_CHARACTER'] = array(
  'name'     => 'Descriptor name',
  'select'   => 'T',
  'maxlen'   => 30,
  'sort'     => true
);
$opts['fdd']['D_UNIT'] = array(
  'name'     => 'Measurement unit',
  'select'   => 'T',
  'maxlen'   => 3,
  'sort'     => true
);
$opts['fdd']['D_STATE_NO'] = array(
  'name'     => 'State number',
  'select'   => 'T',
  'maxlen'   => 10,
  'sort'     => true
);
$opts['fdd']['D_STATE'] = array(
  'name'     => 'State name/value',
  'select'   => 'T',
  'maxlen'   => 30,
  'sort'     => true
);
$opts['fdd']['D_CHAR_TYPE'] = array(
...
$opts['fdd']['D_NO']['js']['required'] = true;
$opts['fdd']['D_NO']['values'] = range(1, 999); 
$opts['fdd']['D_NO']['js']['regexp'] = '/^[0-9]*$/';
$opts['fdd']['D_NO']['js']['hint'] = 'Enter only numbers in the Descriptor number field.';
$opts['fdd']['D_CHARACTER']['js']['required'] = true;
$opts['fdd']['D_CHARACTER']['js']['hint'] = 'Descriptor name field is required.';
$opts['fdd']['D_STATE']['js']['required'] = true;
$opts['fdd']['D_STATE']['js']['hint'] = 'State name field is required.';
$opts['fdd']['D_STATE_NO']['values'] = range(1, 999);
$opts['fdd']['D_STATE_NO']['js']['regexp'] = '/^[0-9 ]*$/';
$opts['fdd']['D_STATE_NO']['js']['hint'] = 'Enter only numbers or blanks in the State number field.';
$opts['fdd']['D_CHAR_TYPE']['js']['required'] = true;
$opts['fdd']['D_CHAR_TYPE']['values'] = array('Unordered', 'Ordered', 'Discrete', 'Continuous', 'Text');
...
?>
<p>
Download as: <a href="../export/excel.php?table=descriptors&sort=T_NO">Excel</a> | <a href="../export/csv.php?table=descriptors&sort=T_NO">CSV</a> | <a href="../export/delta.php">DELTA</a> | <a href="../export/sliks.php">SLIKS</a>
</p>
<hr>
<p align="center">
