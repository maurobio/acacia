...
<?php
if ($config['readonly']) {
	echo "<h3>Browser - Higher Taxa table</h3>";
} else {
	echo "<h3>Editor - Higher Taxa table</h3>";
}	
?>
</center>
<?php
...
$opts['fdd']['T_KINGDOM'] = array(
  'name'     => 'Kingdom name',
  'select'   => 'T',
  'maxlen'   => 50,
  'sort'     => true
);
$opts['fdd']['T_PHYLUM'] = array(
...
$opts['fdd']['T_KINGDOM']['values'] = array('Bacteria', 'Archaea', 'Protista','Plantae', 'Fungi', 'Animalia');
$opts['fdd']['T_PHYLUM']['js']['required'] = true;
$opts['fdd']['T_PHYLUM']['js']['hint'] = 'Phylum/Division name field is required.';
$opts['fdd']['T_CLASS']['js']['required'] = true;
$opts['fdd']['T_CLASS']['js']['hint'] = 'Class name field is required.';
$opts['fdd']['T_ORDER']['js']['required'] = true;
$opts['fdd']['T_ORDER']['js']['hint'] = 'Order name field is required.';
$opts['fdd']['T_FAMILY']['js']['required'] = true;
$opts['fdd']['T_FAMILY']['js']['hint'] = 'Family name field is required.';

// Set the name of the validation script used for INSERT, UPDATE
$opts['triggers']['insert']['before'] = 'validation.php';
...
?>
<p>
Download as: <a href="../export/excel.php?table=highertaxa&sort=T_NO">Excel</a> | <a href="../export/csv.php?table=highertaxa&sort=T_NO">CSV</a>
</p>
<hr>
<p align="center">
