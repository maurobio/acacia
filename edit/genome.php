...
<?php
if ($config['readonly']) {
	echo "<h3>Browser - Genome table</h3>";
} else {
	echo "<h3>Editor - Genome table</h3>";
}	
?>
</center>
<?php
...
// Sorting field(s)
$opts['sort_field'] = array('G_TAXID', 'G_SEQID', 'G_SEQ_TYPE', 'G_DESCRIPTION');
...
$opts['fdd']['G_TAXID'] = array(
  'name'     => 'TaxId',
  'select'   => 'T',
  'maxlen'   => 10,
  'sort'     => true
);
$opts['fdd']['G_SEQID'] = array(
  'name'     => 'SeqId',
  'select'   => 'T',
  'maxlen'   => 10,
  'sort'     => true
);
$opts['fdd']['G_SEQ_TYPE'] = array(
  'name'     => 'Sequence type',
  'select'   => 'T',
  'maxlen'   => 12,
  'sort'     => true
);
$opts['fdd']['G_DESCRIPTION'] = array(
  'name'     => 'Sequence description',
  'select'   => 'T',
  'maxlen'   => 254,
  'sort'     => true
);
$opts['fdd']['G_SEQUENCE'] = array(
  'name'     => 'Sequence',
  'select'   => 'T',
  'maxlen'   => 65535,
  'textarea' => array(
...
$opts['fdd']['G_SEQ_TYPE']['values'] = array('Nucleotide', 'Protein');
...
?>
<p>
Download as: <a href="../export/excel.php?table=genome&sort=T_NO">Excel</a> | <a href="../export/csv.php?table=genome&sort=T_NO">CSV</a> | <a href="../export/fasta.php?sort=T_NO">FASTA</a>
</p>
<hr>
<p align="center">
