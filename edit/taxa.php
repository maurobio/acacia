...
// Sorting field(s)
$opts['sort_field'] = array('T_GENUS', 'T_SPECIES', 'T_SUBSP');
...
$opts['fdd']['T_STATUS'] = array(
  'name'     => 'Name status',
  'select'   => 'T',
  'maxlen'   => 22,
  'sort'     => true
);
$opts['fdd']['T_GENUS'] = array(
  'name'     => 'Generic epithet',
  'select'   => 'T',
  'maxlen'   => 30,
  'sort'     => true
);
$opts['fdd']['T_G_AUTHOR'] = array(
...
$opts['fdd']['T_SPECIES'] = array(
  'name'     => 'Specific epithet',
  'select'   => 'T',
  'maxlen'   => 30,
  'sort'     => true
);
$opts['fdd']['T_S_AUTHOR'] = array(
...
if ($config['subsp']) {
	...
	$opts['fdd']['T_SUBSP'] = array(
		'name'     => 'Subspecific epithet',
		'select'   => 'T',
		'maxlen'   => 30,
		'sort'     => true
	);
	$opts['fdd']['T_SP_AUTHOR'] = array(
...
// Input validation
$opts['fdd']['T_STATUS']['js']['required'] = true;
$opts['fdd']['T_STATUS']['values'] = array('Accepted', 'Provisional');
$opts['fdd']['T_GENUS']['js']['required'] = true;
$opts['fdd']['T_GENUS']['js']['hint'] = 'Generic epithet field is required.';
$opts['fdd']['T_SPECIES']['js']['required'] = true;
$opts['fdd']['T_SPECIES']['js']['hint'] = 'Specific epithet field is required.';
if (!$config['subsp']) {
	$opts['fdd']['T_S_AUTHOR']['js']['hint'] = 'Specific authority field is required.';
}
else {
	$opts['fdd']['T_SP_AUTHOR']['js']['hint'] = 'Subspecific authority field is required.';
}	
...
$opts['triggers']['insert']['after']  = 'categories.php';
$opts['triggers']['update']['before'] = $opts['triggers']['insert']['before'];
$opts['triggers']['delete']['after'] = 'delete.php';
...
?>
<p>
Download as: <a href="../export/excel.php?table=taxa&sort=T_NO">Excel</a> | <a href="../export/csv.php?table=taxa&sort=T_NO">CSV</a>
</p>
<hr>
<p align="center">
