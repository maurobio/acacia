...
<head>
	...
	<title>Bibliography table</title>
...
<?php
if ($config['readonly']) {
	echo "<h3>Browser - Bibliography table</h3>";
} else {
	echo "<h3>Editor - Bibliography table</h3>";
}	
?>
</center>
<?php
...
// Sorting field(s)
$opts['sort_field'] = array('B_AUTHOR', 'B_YEAR');
...
$opts['fdd']['B_NO'] = array(
  'name'     => 'Bibliographic reference number',
  'select'   => 'T',
...
$opts['fdd']['B_TYPE'] = array(
  'name'     => 'Type',
  'select'   => 'T',
  'maxlen'   => 20,
  'sort'     => true
);
$opts['fdd']['B_AUTHOR'] = array(
  'name'     => 'Author',
  'select'   => 'T',
  'maxlen'   => 254,
  'sort'     => true
);
$opts['fdd']['B_YEAR'] = array(
  'name'     => 'Year',
  'select'   => 'T',
  'maxlen'   => 4,
  'sort'     => true
);
$opts['fdd']['B_SEQUENCE'] = array(
  'name'     => 'Publication sequence',
  'select'   => 'T',
  'maxlen'   => 1,
  'sort'     => true
);
$opts['fdd']['B_TITLE'] = array(
  'name'     => 'Publication title',
  'select'   => 'T',
  'maxlen'   => 254,
  'sort'     => true
);
$opts['fdd']['B_DETAIL'] = array(
...
$opts['fdd']['B_NO']['js']['hint'] = 'Enter only numbers in the Bibliographic reference number field.';
$opts['fdd']['B_TYPE']['values'] = array('article', 'book', 'booklet', 'conference', 'incollection', 'inproceedings','manual', 'mastersthesis', 'misc', 'phdthesis', 'proceedings', 'techreport', 'unpublished');
$opts['fdd']['B_AUTHOR']['js']['required'] = true;
$opts['fdd']['B_AUTHOR']['js']['hint'] = 'Author name is required.';
$opts['fdd']['B_YEAR']['js']['required'] = true;
//$opts['fdd']['B_YEAR']['values'] = range(1, 9999);
$opts['fdd']['B_YEAR']['js']['hint'] = 'Enter only numbers in the Year field.';
$opts['fdd']['B_SEQUENCE']['values'] = array(' ', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z');
$opts['fdd']['B_TITLE']['js']['required'] = true;
$opts['fdd']['B_TITLE']['js']['hint'] = 'Title field is required.';
$opts['fdd']['B_DETAIL']['js']['required'] = true;
$opts['fdd']['B_DETAIL']['js']['hint'] = 'Detail field is required.';
...
?>
<p>
Download as: <a href="../export/excel.php?table=bibliography&sort=B_NO">Excel</a> | <a href="../export/csv.php?table=bibliography&sort=B_NO">CSV</a> | <a href="../export/bibtex.php?sort=B_NO">BibTeX</a>
</p>
<hr>
<p align="center">
