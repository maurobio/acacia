...
<?php
	...
	$result = mysqli_query($sql, $link) or die("Error creating temporary table");
	...
	$result = mysqli_query($sql, $link) or die("Error: ". mysqli_error());
...
<?php 
	...
	elseif ($field == "V_NAME") {
		echo ".....      Common name contains '".strtolower($filter)."'".$expr;
	}
	elseif ($field == "U_NAME") {
